...
<body>
<form method="post" action="/Assignment_war_exploded/MauSac/store" style="margin: 30px; border: 1px solid white;background-color: #e9ecef;border-radius: 25px">
    <div style="margin: 20px">
        <center><h1>Màu Sắc</h1></center><br>
        <div class="mb-3 row">
