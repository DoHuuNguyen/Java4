...
<body>
<form method="post" action="/Assignment_war_exploded/SanPham/update?ma=${sp.ma}" style="margin: 30px; border: 1px solid white;background-color: #e9ecef;border-radius: 25px">
