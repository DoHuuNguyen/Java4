...
<body>
<form method="post" action="/Assignment_war_exploded/ChucVu/update?ma=${cv.ma}" style="margin: 30px; border: 1px solid white;background-color: #e9ecef;border-radius: 25px">
